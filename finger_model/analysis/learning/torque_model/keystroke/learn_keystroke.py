...
# plots.animate(reference, dt, "keystroke_torque_model", tendons=True)

# Learn to reproduce trajectory using gradient descent.
learn_gradient_descent(reference, interval, 250, .1, loss_function=loss_angles, tendons=False, name="keystroke_torque_model")
